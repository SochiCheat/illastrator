...
throw new SyntaxError('JSON.parse');};}})();;// Validate all required fields before submission.
...
;$(document).ready(
    function(){
      $(".ntype-drigg").hover(
        function () {
          $(this).addClass("herenow");
        }, 
        function () {
          $(this).removeClass("herenow", "slow");
        }
      );
    }    
...
{
  $(".flag-bury .flag-action").each(function()
  {
    $(this).click(function()
    {
      $(this).parents(".node").fadeTo("slow", 0.005, function(){ //fade

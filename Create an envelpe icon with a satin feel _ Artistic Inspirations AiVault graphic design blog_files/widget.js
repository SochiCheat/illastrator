if(typeof(linkwithin_is_running)==='undefined'){linkwithin_is_running=true;LW={v:35,u:'http://widget'+(Math.random()<0.6?(Math.random()<0.35?'':'3'):'2')+'.linkwithin.com/',hs:[],ts:[],ps:[],ws:[],wsl:[],dh:0};LW.m=function(f,a){var a2=[];for(var i=0,l=a.length;i!==l;++i){a2.push(f(a[i]));}
